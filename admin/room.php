                                ...
                                class AddRoom
                                {
                                    ...
                                    public function addRoom()
                                    {
                                        ...
                                        if (isset($_POST['add'])) {
                                            ...
                                            if ($data[0] > 0) { //if room already exist
                                                echo "<script type='text/javascript'> alert('Room Already in Exists')</script>";

                                            } else {


                                                $this->sql = "INSERT INTO `room`( `type`, `bedding`,`place`) VALUES ('$room','$bed','$place')";
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel panel-default">
                                        <?php
                                        include('db.php');
                                        $addNewRoom->sql = "select * from room limit 0,15";
                                        $re = mysqli_query($con, $addNewRoom->sql)
                                            ?>
                                        <div class="panel-body">
