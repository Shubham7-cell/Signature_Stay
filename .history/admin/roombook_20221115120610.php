		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a style=" background: #7b68ee;" class="active-menu" href="home.php"><i
								class="fa fa-dashboard"></i> Status</a>
					</li>
					<li>
						<a href="reservation.php"><i class="fa fa-desktop"></i> Reservation </a>
					</li>
					<li>
						<a style=" background: #7b68ee;" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Room
							Booking</a>
					</li>
					<li>
			...
			<div id="page-inner">
				...
				<div class="row">
                    ...
                    class room
                    {
	                    ...
	                    {
		                    include('db.php');
		                    $this->csql = "select * from payment";
		                    $this->cre = mysqli_query($con, $this->csql);
		                    $this->cr = 0;
		                    $this->csc = 0;
		                    $this->cgh = 0;
		                    $this->csr = 0;
		                    $this->cdr = 0;
		                    while ($this->crow = mysqli_fetch_array($this->cre)) {
			                    $this->cr = $this->cr + 1;
			                    $this->cs = $this->crow['troom'];

			                    if ($this->cs == "Superior Room") {
				                    $this->csc = $this->csc + 1;
			                    }

			                    if ($this->cs == "Guest House") {
				                    $this->cgh = $this->cgh + 1;
			                    }
			                    if ($this->cs == "Single Room") {
				                    $this->csr = $this->csr + 1;
			                    }
			                    if ($this->cs == "Deluxe Room") {
				                    $this->cdr = $this->cdr + 1;
			                    }
		                    }
	                    }
