		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SIGNATURE <span>STAY</span><p class="logo_w3l_agile_caption">Luxury at its Finest</p></a></h1>
				</div>
...
<!-- //gallery -->
  ...
  <!-- visitors -->
			<div class="copy">
		        <p>© 2022 SIGNATURE STAY . All Rights Reserved | Design by <a href="index.php">Shubham Golwal, Vyom Doshi</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
