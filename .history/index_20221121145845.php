...
<body>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SIGNATURE <span>STAY</span>
							<p class="logo_w3l_agile_caption">Luxury at its Finest</p>
						</a></h1>
				</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>SIGNATURE <span> STAY</span></h4>
	...
	<div class="banner-bottom">
		<div class="container">
			<div class="agileits_banner_bottom">
				<h3><span>Experience a luxurious stay, enjoy fantastic offers</span> Find our friendly welcoming
					reception</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SIGNATURE STAY</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About Our SIGNATURE STAY</h3>
				...
				<div class="resp-tabs-container">
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Shubham Golwal</h4>
							<span>Fullstack developer</span>
							<p>UID: 2020300015<br>Grade: T.E COMPS - A</p>
					...
					<div class="tab2">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Vyom Doshi</h4>
							<span>Fullstack developer</span>
							<p>UID: 2020300009<br>Grade: T.E COMPS - A</p>
	...
	<!-- visitors -->
	<div class="copy">
		<p>© 2022 SIGNATURE STAY . All Rights Reserved | Design by <a href="index.php">Shubham Golwal, Vyom Doshi</a>
		</p>
	</div>
	<!--/footer -->
	<!-- js -->
